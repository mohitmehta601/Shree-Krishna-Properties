                ...
                <div className="flex items-start justify-between mb-4">
                  <div className="flex-1">
                    ...
                    <p className="text-gray-600 text-sm">
                      {inquiry.property.full_location}
                    </p>
                    <p className="text-xs text-gray-500 mt-1">
                      ID: {inquiry.property.unique_code}
                    </p>
                  </div>
                  <span
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4 p-4 bg-gray-50 rounded-lg">
                  <div className="space-y-2">
                    ...
                    <p className="text-sm text-gray-700">
                      <strong>Name:</strong> {inquiry.profile.name}
                    </p>
                  ...
                  <div className="space-y-2">
                    ...
                    <p className="text-sm text-gray-700">
                      ...
                      {formatDate(inquiry.requested_visit_datetime)}
                    </p>
                    {inquiry.admin_assigned_datetime && (
                      <p className="text-sm text-green-700">
                        <strong>Approved for:</strong>{" "}
                        {formatDate(inquiry.admin_assigned_datetime)}
                      </p>
                    )}
                    {inquiry.admin_notes && (
                      <p className="text-sm text-gray-700">
